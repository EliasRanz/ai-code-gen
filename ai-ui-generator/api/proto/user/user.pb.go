...
const file_api_proto_user_proto_rawDesc = "" +
	"\n" +
	"\x14api/proto/user.proto\x12\x04user\"\x9b\x02\n" +
	"\x04User\x12\x0e\n" +
	...
	"\x10ListUserProjects\x12\x1d.user.ListUserProjectsRequest\x1a\x1e.user.ListUserProjectsResponseBAZ?github.com/EliasRanz/ai-code-gen/ai-ui-generator/api/proto/userb\x06proto3"
