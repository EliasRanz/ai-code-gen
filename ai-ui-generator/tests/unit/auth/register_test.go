...
func (m *mockUserRepo) GetByEmail(email string) (*user.User, error) {
	if m.exists { return &user.User{Email: email}, nil }
	return nil, nil
}
func (m *mockUserRepo) GetByID(id string) (*user.User, error) { return nil, nil }
func (m *mockUserRepo) Create(u *user.User) error {
	if m.createOK { u.ID = "mock-id"; return nil }
	return fmt.Errorf("create failed")
}
func (m *mockUserRepo) Update(id string, updates map[string]interface{}) (*user.User, error) { return nil, nil }
