...
func (p *JWTTokenProvider) GenerateAccessToken(userID UserID) (string, error) {
...
func (p *JWTTokenProvider) GenerateRefreshToken(userID UserID) (string, error) {
	claims := jwt.MapClaims{
		"sub":  string(userID),
		"iss":  p.issuer,
		"iat":  time.Now().Unix(),
...
func (p *JWTTokenProvider) ValidateAccessToken(tokenString string) (UserID, error) {
	return p.validateToken(tokenString, "access")
}

// ValidateRefreshToken validates a refresh token and returns the user ID
func (p *JWTTokenProvider) ValidateRefreshToken(tokenString string) (UserID, error) {
	return p.validateToken(tokenString, "refresh")
}

// validateToken validates a token and returns the user ID
func (p *JWTTokenProvider) validateToken(tokenString, expectedType string) (UserID, error) {
