...
const file_api_proto_auth_proto_rawDesc = "" +
	...
	"\n" +
	"expires_in\x18\x02 \x01(\x03R\texpiresIn2\x85\x02\n" +
	"\vAuthService\x120\n" +
	...
	"\fRefreshToken\x12\x19.auth.RefreshTokenRequest\x1a\x1a.auth.RefreshTokenResponseB1Z/github.com/EliasRanz/ai-code-gen/api/proto/authb\x06proto3"
